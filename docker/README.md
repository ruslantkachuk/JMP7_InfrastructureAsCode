...
**Step 2**: depending on the operating system, maybe need to install additionally docker-compose tool. Check this by call the command: docker-compose --version from commant line. Additional info https://docs.docker.com/compose/
